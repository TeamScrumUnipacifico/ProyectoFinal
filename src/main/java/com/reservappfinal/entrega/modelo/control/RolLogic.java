...
import com.reservappfinal.entrega.dataaccess.dao.IRolDAO;
import com.reservappfinal.entrega.dataaccess.dao.IUsuarioDAO;
    ...
    public List<RolDTO> getDataRol() throws Exception {
        try {
            ...
            for (Rol rolTmp : rol) {
                ...
                rolDTO2.setRolNombre((rolTmp.getRolNombre() != null)
                    ? rolTmp.getRolNombre() : null);
                rolDTO.add(rolDTO2);
            }
