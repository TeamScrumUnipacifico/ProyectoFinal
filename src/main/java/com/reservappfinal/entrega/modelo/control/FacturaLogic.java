    ...
    */
    ...
    public void saveFactura(Factura entity) throws Exception {
        ...
        try {
            ...
            if (getFactura(entity.getCodigoFactura()) != null) {
    ...
    public void deleteFactura(Factura entity) throws Exception {
        ...
        if (entity.getCodigoFactura() == null) {
            throw new ZMessManager().new EmptyFieldException("codigoFactura");
        }
    ...
    public List<FacturaDTO> getDataFactura() throws Exception {
        try {
            ...
            for (Factura facturaTmp : factura) {
                ...
                facturaDTO2.setCodigoFactura(facturaTmp.getCodigoFactura());
                ...
                facturaDTO2.setCodigoReserva_Reserva((facturaTmp.getReserva()
                                                                .getCodigoReserva() != null)
                    ? facturaTmp.getReserva().getCodigoReserva() : null);
    ...
    public Factura getFactura(Integer codigoFactura) throws Exception {
        ...
        try {
            entity = facturaDAO.findById(codigoFactura);
        } catch (Exception e) {
